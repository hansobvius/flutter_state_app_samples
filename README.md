...
-   **`listenable_builder/`**: Examples using the built-in [ListenableBuilder](https://api.flutter.dev/flutter/widgets/ListenableBuilder-class.html) widget.
...
2.  Select one of the pre-configured launch targets:
    ...
    *   `ListenableBuilder Simple App` / `ListenableBuilder Advanced App`
...
Check the `pubspec.yaml` in each respective folder (`bloc/`, `listenable_builder/`, `mobx/`, `riverpod/`) for the specific versions of the libraries used.
